The services folder is where all the logic is store in, like getting information for the database, another API, getting data from file, performing a task etc
